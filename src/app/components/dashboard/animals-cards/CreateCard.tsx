  ...
  return (
    <Dialog open={open} onOpenChange={setIsOpen}>
      <DialogTrigger className="group w-full sm:w-[300px]">
        ...
        <Card className="flex h-[425px] flex-col items-center justify-center overflow-hidden border-2 border-dashed bg-gray-50 shadow-none transition-colors hover:border-gray-400 sm:w-[300px]">
